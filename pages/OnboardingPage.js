...
export class OnboardingPage {
    constructor(page) {
        ...
        this.hbA1cInput = this.page.getByRole('spinbutton');
    }
    ...
    async fillValue(value) {
        const valueLocator = this.page.getByRole('spinbutton');
        await valueLocator.fill(value);
    }
    ...
    async verifyHbA1cInputField() {
        await expect(this.hbA1cInput).toBeVisible();
    }
    ...
    async enterHbA1cValue(value) {
        await this.hbA1cInput.fill(value);
    }
